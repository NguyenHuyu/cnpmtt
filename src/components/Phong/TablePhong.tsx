...
import { useGetRoomsQuery, useDeleteRoomMutation } from '@/redux/exportModule'
import {
  Modal,
  ModalContent,
  ModalHeader,
...
const TablePhong = () => {
  ...
  useEffect(() => {
    if (inputSearch != '') {
      const filterData = dataRooms.filter((data: any) => {
